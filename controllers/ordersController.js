  ...
  try {
      ...
      db.query(
          ...
          (err, result) => {
              ...
              // Преобразуем строку car в объект
...
// Получение заказов для администратора
exports.getAdminOrders = (req, res) => {
  const token = req.headers.authorization;
  ...
  try {
      ...
      db.query(
          ...
          (err, result) => {
              ...
              // Подготавливаем данные для вставки услуг
              ...
              db.query(
                  ...
                  (err) => {
                      ...
                      // Получаем полные данные о созданном заказе
                      db.query(
                          `SELECT 
                              o.*,
                              JSON_OBJECT(
